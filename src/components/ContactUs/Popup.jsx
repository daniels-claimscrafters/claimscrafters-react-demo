  ...
  return (
    ...
    >
      ...
      <p style={{ 
        ...
        lineHeight: '30px',
        marginTop: '20px',
      }}>Thank you for reaching out to us! Your message has been successfully sent. We value your input and will get back to you as soon as possible. Keep an eye on your inbox for our response</p>
      <button style={{
        padding: '10px 20px',
        borderRadius: '4px',
